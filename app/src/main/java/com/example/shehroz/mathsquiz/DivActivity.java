...
public class DivActivity extends AppCompatActivity {
        ...
        for (int i = 0; i < 4; i++) {
            if (i == locationOfCorrectAnswer) {
                ...
                if(i<2){
                    ...
                    incorrectAnswer =(a/b) + (rand.nextInt(4) + 2);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ring= MediaPlayer.create(DivActivity.this,R.raw.tick_tock);
        fTone= MediaPlayer.create(DivActivity.this,R.raw.finishing_tone);
        wosh= MediaPlayer.create(DivActivity.this,R.raw.wosh);
        endingTone= MediaPlayer.create(DivActivity.this,R.raw.ending_tone);
        wrongTone= MediaPlayer.create(DivActivity.this,R.raw.wrong_ans);
        winningTone= MediaPlayer.create(DivActivity.this,R.raw.winning_tone);
        appp= MediaPlayer.create(DivActivity.this,R.raw.appp);
        ...
        timer=new CountDownTimer(30100, 1000) {
            ...
            public void onFinish() {
                ...
                if (per >= 80) {
                    String sc = sp.getString("ScoreDiv", "0");
                    ...
                    if (sc!=null) {
                        ...
                        if (score > ss) {
                            edit.putString("ScoreDiv", Integer.toString(score));
                            edit.putString("PerDiv", numberAsString);
                            hs = 1;
                            ending();
                        }
                    }
                    ...
                    String sc = sp.getString("ScoreDiv", "0");
                    edit.putString("ScoreDiv", sc);
                    String pc = sp.getString("PerDiv", "0");
                    edit.putString("PerDiv", pc);
                }
                edit.apply();
    ...
    public boolean ShowHighScoreDBox(String ss,String perscs) {
        final Dialog de = new Dialog(DivActivity.this);
        de.setTitle(" Score");

...
public class AllActivity extends AppCompatActivity {
    ...
    public void generrateQues(){
        ...
        if(oper==1) {
            ...
            for (int i = 0; i < 4; i++) {
                if (i == locationOfCorrectAnswer) {
                    ...
                    if(i<2)
                        incorrectAnswer = ((a-b)-(rand.nextInt(5) + 2));
                    else
                        incorrectAnswer = ((a-b)+(rand.nextInt(5) + 2));
            ...
            for (int i = 0; i < 4; i++) {
                if (i == locationOfCorrectAnswer) {
                    ...
                    if(i<2)
                        incorrectAnswer = ((a*b)+(rand.nextInt(3) + 1));
                    else
                        incorrectAnswer = ((a*b)-(rand.nextInt(4) + 1));
                    while (incorrectAnswer == a * b) {
                        incorrectAnswer = ((a*b)-(rand.nextInt(2) + 1));
                    }
                    answers.add(incorrectAnswer);
                }
            ...
            for (int i = 0; i < 4; i++) {
                if (i == locationOfCorrectAnswer) {
                    ...
                    if(i<2){
                        incorrectAnswer = ((a/b) + (rand.nextInt(3) + 2));
                   }
                    else{
                        incorrectAnswer = ((a/b) - (rand.nextInt(3) + 2));
        ...
        switch(oper){
            ...
            case 3:{
                ques.setText(Integer.toString(a)+" x "+Integer.toString(b));
                break;
            }
            case 4:{
                ques.setText(Integer.toString(a)+" "+(char)247+" "+Integer.toString(b));
                break;
            }
        }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ring= MediaPlayer.create(AllActivity.this,R.raw.tick_tock);
        fTone= MediaPlayer.create(AllActivity.this,R.raw.finishing_tone);
        wosh= MediaPlayer.create(AllActivity.this,R.raw.wosh);
        endingTone= MediaPlayer.create(AllActivity.this,R.raw.ending_tone);
        wrongTone= MediaPlayer.create(AllActivity.this,R.raw.wrong_ans);
        winningTone= MediaPlayer.create(AllActivity.this,R.raw.winning_tone);
        appp= MediaPlayer.create(AllActivity.this,R.raw.appp);
        ...
        timer=new CountDownTimer(30100, 1000) {
            ...
            public void onFinish() {
                ...
                if (per >= 80) {
                    ...
                    String sc = sp.getString("ScoreAll", "0");
                    ...
                    if (sc!=null) {
                        ...
                        if (score > ss) {
                            edit.putString("ScoreAll", Integer.toString(score));
                            edit.putString("PerAll", numberAsString);
                            hs = 1;
                            ending();
                        }
                    }
                        ...
                        edit.putString("ScoreAll", "0");
                        edit.putString("PerAll", "0");


                    }
                } else {
                    String sc = sp.getString("ScoreAll", "0");
                    edit.putString("ScoreAll", sc);
                    String pc = sp.getString("PerAll", "0");
                    edit.putString("PerAll", pc);
                }
                edit.apply();
    ...
    public boolean ShowHighScoreDBox(String ss,String perscs) {
        ...
        final Dialog de = new Dialog(AllActivity.this);

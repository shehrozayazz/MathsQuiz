...
public class MulActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ring= MediaPlayer.create(MulActivity.this,R.raw.tick_tock);
        fTone= MediaPlayer.create(MulActivity.this,R.raw.finishing_tone);
        wosh= MediaPlayer.create(MulActivity.this,R.raw.wosh);
        endingTone= MediaPlayer.create(MulActivity.this,R.raw.ending_tone);
        wrongTone= MediaPlayer.create(MulActivity.this,R.raw.wrong_ans);
        winningTone= MediaPlayer.create(MulActivity.this,R.raw.winning_tone);
        appp= MediaPlayer.create(MulActivity.this,R.raw.appp);
        ...
        timer=new CountDownTimer(30100, 1000) {
            ...
            public void onFinish() {
                ...
                if (per >= 80) {
                    ...
                    String sc = sp.getString("ScoreMul", "0");
                    ...
                    if (sc!=null) {
                        ...
                        if (score > ss) {
                            edit.putString("ScoreMul", Integer.toString(score));
                            edit.putString("PerMul", numberAsString);
                            hs = 1;
                            ending();
                        }
                    }
                        ...
                        edit.putString("ScoreMul", "0");
                        edit.putString("PerMul", "0");
                    ...
                    String pc = sp.getString("PerMul", "0");
                    edit.putString("PerMul", pc);
                }
                edit.apply();
    ...
    public boolean ShowHighScoreDBox(String ss,String perscs) {
        ...
        final Dialog de = new Dialog(MulActivity.this);

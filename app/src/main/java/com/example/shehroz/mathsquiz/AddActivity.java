...
public class AddActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ring= MediaPlayer.create(AddActivity.this,R.raw.tick_tock);
        fTone= MediaPlayer.create(AddActivity.this,R.raw.finishing_tone);
        wosh= MediaPlayer.create(AddActivity.this,R.raw.wosh);
        endingTone= MediaPlayer.create(AddActivity.this,R.raw.ending_tone);
        wrongTone= MediaPlayer.create(AddActivity.this,R.raw.wrong_ans);
        winningTone= MediaPlayer.create(AddActivity.this,R.raw.winning_tone);
        appp= MediaPlayer.create(AddActivity.this,R.raw.appp);
      ...
      result.setText( Integer.toString(score) + "/" + Integer.toString(Tques));
               //ShowHighScoreDBox(String.valueOf(score));
                ...
                if (per >= 80) {
                    ...
                    String sc = sp.getString("ScoreAdd", "0");
                    ...
                    if (sc!=null) {
                       ...
                       if (score > ss) {
                           edit.putString("ScoreAdd", Integer.toString(score));
                           edit.putString("PerAdd", numberAsString);
                           hs = 1;
                            ending();
                       }
                   }
                    ...
                    String sc = sp.getString("ScoreAdd", "0");
                    edit.putString("ScoreAdd", sc);
                    String pc = sp.getString("PerAdd", "0");
                    edit.putString("PerAdd", pc);
                }
                edit.apply();
    ...
    public boolean ShowHighScoreDBox(String ss,String perscs) {
        ...
        final Dialog de = new Dialog(AddActivity.this);
